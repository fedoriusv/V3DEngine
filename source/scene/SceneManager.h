...
namespace scene
{
    ...
    public:
        ...
        CNode*                  addFreeTypeFont(CNode* parent = nullptr, const std::string& text = "text", const Vector3D& pos = Vector3D(0.0f), const u32 size = 24U, const std::string& font = "arial.ttf");
