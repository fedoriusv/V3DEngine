...
namespace renderer
{
    ...
    private:
        ...
        s32                 setUniformVector2(const u32 shader, const std::string& name, core::Vector2D& vector)                    override;
        s32                 setUniformVector3(const u32 shader, const std::string& name, core::Vector3D& vector)                    override;
        s32                 setUniformVector4(const u32 shader, const std::string& name, core::Vector4D& vector)                    override;
