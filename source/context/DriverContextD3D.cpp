...
CDriverContextD3D::CDriverContextD3D(const platform::WindowPtr& window)
...
CDriverContextD3D::~CDriverContextD3D()
{
}
...
bool CDriverContextD3D::createWin32Context()
{
    ...
    CDriverContextD3D::checkForErrors("Create Context");
...
ID3D11DeviceContext* CDriverContextD3D::getD3DContext() const
{
    return m_deviceContext;
}

ID3D11RenderTargetView* CDriverContextD3D::getD3DTargetView() const
{
    return m_renderTargetView;
}
#endif //_PLATFORM_WIN_

void CDriverContextD3D::driverInfo()
{
...
#ifdef _DEBUG
    CDriverContextD3D::printExtensionList();
#endif
}

void CDriverContextD3D::checkForErrors(const std::string& location)
{
#ifdef _DEBUG
    //TODO:
#endif
...
bool CDriverContextD3D::setVSync(bool use)
{
...
void CDriverContextD3D::flushBuffers()
{
    if (m_swapChain)
    {
        m_swapChain->Present(m_vsyncValue, 0);
    }
}
